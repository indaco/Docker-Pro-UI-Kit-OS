...
//        node.tag === "link" && console.log(node.attrs.href);
    ...
    image: undefined,
 	...
 	const filter = /^\.(flex|hidden|dark|enabled|transition|transform|esase-in|ease-out|duration-100|duration-150|opacity-0|opacity-100|scale-95|scale-100|translate-y-0|-translate-y-full|shadow-md|)$/;
